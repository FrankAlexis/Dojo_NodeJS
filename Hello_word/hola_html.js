...
var http = require("http"),
    fs = require("fs");
/*modulo para conectarse con el sistema de archivos en la computadora (paso 2)*/
/*Forma sincrona (paso 6)
Donde al servidor le toca esperar la respuesta para leer el archivo*/

var html = fs.readFileSync("./index.html");
/*Busca dentro de la misma carpeta y retorna el contenido del archivo (paso 7)*/
...
http.createServer(function(req, res) { //Solicitud y respuesta (paso 4)
    ...
    console.log("4")
}).listen(8000); //puerto de escucha (paso 5) 
console.log("5")
